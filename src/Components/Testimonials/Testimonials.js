...
const Testimonials = () => {
    return (
        <div className="mb-5">
            <Container>
                <h1 className="mt-5 mb-5 text-center fw-bold">Testimonials</h1>
                <div>
                    <Swiper
                        slidesPerView={3}
                        spaceBetween={30}
                        ...
                        <SwiperSlide>
                            ...
                            <div>
                                <p className="lead">
                                    ...
                                    deserunt ipsam iste aperiam quasi debitis.
                                    Eius quidem accusantium illo accusamus
                                    sapiente veritatis voluptate cumque nisi
                                    itaque magnam!
                                </p>
                                <Rating
                                    placeholderRating={5}
